...
# Hierarchical cell: RS_0
proc create_hier_cell_RS_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" create_hier_cell_RS_0() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: decoder_dma, and set properties
  set decoder_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 decoder_dma ]
...
CONFIG.c_sg_length_width {20} \
  ...
  # Create instance: encoder_dma, and set properties
  set encoder_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 encoder_dma ]
  set_property -dict [ list \
CONFIG.c_include_sg {0} \
CONFIG.c_m_axis_mm2s_tdata_width {8} \
CONFIG.c_mm2s_burst_size {16} \
CONFIG.c_sg_length_width {20} \
  ...
  # Create instance: rsDecoderWrapper_0, and set properties
  set rsDecoderWrapper_0 [ create_bd_cell -type ip -vlnv dsumorok.com:user:rsDecoderWrapper:1.0 rsDecoderWrapper_0 ]

  # Create instance: rsEncoderWrapper_0, and set properties
  set rsEncoderWrapper_0 [ create_bd_cell -type ip -vlnv dsumorok.com:user:rsEncoderWrapper:1.0 rsEncoderWrapper_0 ]
...
CONFIG.NUM_PORTS {4} \
  ...
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_protocol_converter_3/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_protocol_converter_0/S_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins decoder_dma/M_AXIS_MM2S] [get_bd_intf_pins rsDecoderWrapper_0/dataIn]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_protocol_converter_1/S_AXI] [get_bd_intf_pins decoder_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_protocol_converter_2/S_AXI] [get_bd_intf_pins decoder_dma/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins encoder_dma/M_AXIS_MM2S] [get_bd_intf_pins rsEncoderWrapper_0/dataIn]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins axi_protocol_converter_5/S_AXI] [get_bd_intf_pins encoder_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins axi_protocol_converter_4/S_AXI] [get_bd_intf_pins encoder_dma/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_protocol_converter_0_M_AXI [get_bd_intf_pins axi_protocol_converter_0/M_AXI] [get_bd_intf_pins decoder_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_protocol_converter_1_M_AXI [get_bd_intf_pins M_AXI] [get_bd_intf_pins axi_protocol_converter_1/M_AXI]
  connect_bd_intf_net -intf_net axi_protocol_converter_2_M_AXI [get_bd_intf_pins M_AXI1] [get_bd_intf_pins axi_protocol_converter_2/M_AXI]
  connect_bd_intf_net -intf_net axi_protocol_converter_3_M_AXI [get_bd_intf_pins axi_protocol_converter_3/M_AXI] [get_bd_intf_pins encoder_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_protocol_converter_4_M_AXI [get_bd_intf_pins M_AXI2] [get_bd_intf_pins axi_protocol_converter_4/M_AXI]
  connect_bd_intf_net -intf_net axi_protocol_converter_5_M_AXI [get_bd_intf_pins M_AXI3] [get_bd_intf_pins axi_protocol_converter_5/M_AXI]
  connect_bd_intf_net -intf_net rsDecoderWrapper_0_dataOut [get_bd_intf_pins decoder_dma/S_AXIS_S2MM] [get_bd_intf_pins rsDecoderWrapper_0/dataOut]
  connect_bd_intf_net -intf_net rsEncoderWrapper_0_dataOut [get_bd_intf_pins encoder_dma/S_AXIS_S2MM] [get_bd_intf_pins rsEncoderWrapper_0/dataOut]

  # Create port connections
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_protocol_converter_1/aresetn] [get_bd_pins axi_protocol_converter_2/aresetn] [get_bd_pins axi_protocol_converter_3/aresetn] [get_bd_pins axi_protocol_converter_4/aresetn] [get_bd_pins axi_protocol_converter_5/aresetn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins decoder_dma/mm2s_introut] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins decoder_dma/s2mm_introut] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins encoder_dma/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins encoder_dma/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_resetn_1 [get_bd_pins axi_resetn] [get_bd_pins decoder_dma/axi_resetn] [get_bd_pins encoder_dma/axi_resetn] [get_bd_pins rsDecoderWrapper_0/resetn] [get_bd_pins rsEncoderWrapper_0/resetn]
  connect_bd_net -net s_axi_lite_aclk_1 [get_bd_pins s_axi_lite_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_protocol_converter_1/aclk] [get_bd_pins axi_protocol_converter_2/aclk] [get_bd_pins axi_protocol_converter_3/aclk] [get_bd_pins axi_protocol_converter_4/aclk] [get_bd_pins axi_protocol_converter_5/aclk] [get_bd_pins decoder_dma/m_axi_mm2s_aclk] [get_bd_pins decoder_dma/m_axi_s2mm_aclk] [get_bd_pins decoder_dma/s_axi_lite_aclk] [get_bd_pins encoder_dma/m_axi_mm2s_aclk] [get_bd_pins encoder_dma/m_axi_s2mm_aclk] [get_bd_pins encoder_dma/s_axi_lite_aclk] [get_bd_pins rsDecoderWrapper_0/clk] [get_bd_pins rsEncoderWrapper_0/clk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RS_0
  create_hier_cell_RS_0 [current_bd_instance .] RS_0
...
CONFIG.CONST_VAL {0} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net RS_0_M_AXI [get_bd_intf_pins RS_0/M_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP3]
  connect_bd_intf_net -intf_net RS_0_M_AXI1 [get_bd_intf_pins RS_0/M_AXI1] [get_bd_intf_pins processing_system7_0/S_AXI_HP2]
  connect_bd_intf_net -intf_net RS_0_M_AXI2 [get_bd_intf_pins RS_0/M_AXI2] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  connect_bd_intf_net -intf_net RS_0_M_AXI3 [get_bd_intf_pins RS_0/M_AXI3] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports IIC_0] [get_bd_intf_pins processing_system7_0/IIC_0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins RS_0/S_AXI1] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP1 [get_bd_intf_pins RS_0/S_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP1]

  # Create port connections
  connect_bd_net -net RS_0_dout [get_bd_pins RS_0/dout] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins RS_0/aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins RS_0/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins RS_0/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RS_0/decoder_dma/S_AXI_LITE/Reg] SEG_decoder_dma_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RS_0/encoder_dma/S_AXI_LITE/Reg] SEG_encoder_dma_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces RS_0/decoder_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces RS_0/decoder_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP3/HP3_DDR_LOWOCM] SEG_processing_system7_0_HP3_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces RS_0/encoder_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces RS_0/encoder_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
...
preplace inst RS_0 -pg 1 -lvl 2 -y 260 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -y 300 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 3 1 NJ
preplace netloc RS_0_M_AXI1 1 2 1 640
preplace netloc RS_0_M_AXI2 1 2 1 N
preplace netloc RS_0_M_AXI3 1 2 1 650
preplace netloc processing_system7_0_M_AXI_GP0 1 1 3 420 490 NJ 490 1130
preplace netloc processing_system7_0_M_AXI_GP1 1 1 3 410 500 NJ 500 1120
preplace netloc processing_system7_0_IIC_0 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET1_N 1 0 4 30 350 370J 520 NJ 520 1100
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 1 1 380
preplace netloc xlconstant_0_dout 1 3 1 1130
preplace netloc RS_0_dout 1 2 1 650
preplace netloc processing_system7_0_FIXED_IO 1 3 1 NJ
preplace netloc RS_0_M_AXI 1 2 1 660
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 1 400
preplace netloc processing_system7_0_FCLK_CLK1 1 0 4 20 300 390 350 660 510 1110
levelinfo -pg 1 0 200 530 880 1150 -top 0 -bot 530
",
}
